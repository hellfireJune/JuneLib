...
namespace JuneLib
{
    public static class JuneLibRoomRewardAPI
    {
        ...
        {
            Hook roomClearRewardHook = new Hook(typeof(RoomHandler).GetMethod("HandleRoomClearReward", BindingFlags.Public | BindingFlags.Instance), typeof(JuneLibRoomRewardAPI).GetMethod("RoomClearRewardHook"));
        }
        ...
        public static void RoomClearRewardHook(Action<RoomHandler> orig, RoomHandler self)
        {
            try
            {
                ...
                if (JuneLibCore.OnRoomRewardDetermineContents != null) JuneLibCore.OnRoomRewardDetermineContents(self, contentsSet, num);
                ...
                if (flag2)
                {
                    ...
                    JuneLibCore.OnRoomClearItemDrop?.Invoke(debrisObject, self);
